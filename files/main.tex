...
\begin{figure}[!ht]
        \centering
        \hbox{\hspace{0.0em} \includegraphics[scale=0.55] {SIR_a_incorreto.png}}
\end{figure} 
\newpage
\begin{figure}[!ht]
        \centering
        \hbox{\hspace{0.0em} \includegraphics[scale=0.55] {SEI_a_incorreto.png}}
\end{figure} 
...
\begin{figure}[!ht]
        \centering
        \hbox{\hspace{0.0em} \includegraphics[scale=0.55] {SIR_a_correto.png}}
\end{figure} 
\newpage
\begin{figure}[!ht]
        \centering
        \hbox{\hspace{0.0em} \includegraphics[scale=0.55] {SEI_a_correto.png}}
\end{figure}
...
\end{cases}
\end{gather*}
Utilizando as equações atualizadas, 
\\\\
